...
static constexpr auto qt_meta_stringdata_CLASSResultsENDCLASS = QtMocHelpers::stringData(
    "Results",
    "updateTableWidget",
    "",
    "errorType",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSResultsENDCLASS_t qt_meta_stringdata_CLASSResultsENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 17),  // "updateTableWidget"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 9),  // "errorType"
...
void Results::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateTableWidget((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
}
