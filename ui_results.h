...
public:
    ...
    void setupUi(QDialog *Results)
    {
        ...
        Results->resize(674, 311);
        tableWidget = new QTableWidget(Results);
        ...
        tableWidget->setGeometry(QRect(10, 10, 641, 281));
    ...
    void retranslateUi(QDialog *Results)
    {
        ...
        ___qtablewidgetitem->setText(QCoreApplication::translate("Results", "Fehler", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("Results", "Beschreibung", nullptr));
    } // retranslateUi
